			...
			<div id="pokedex-blue-shadow">
				<div id="pokedex-blue-frame">
					<div id="pokedex-title-area">
						<span class="pokedex-title-txt">Sign up</span> <img
					...
					<div id="pokedex-white-bg">
						<form action="SignupC" method="post">
							<div class="btn-container">
								<div>
									<img class="user-icon"
										src="img/icon/account-icon/profile-user1.png"> <input
										class="info-input-btn" type="text" name="Name"
										placeholder="Name" minlength="3" required>
								</div>
								<div>
									<img class="user-icon"
										src="img/icon/account-icon/profile-user2.png"> <input
										class="info-input-btn" type="text" name="UserName"
								...
								<div>
									...
									<input class="info-input-btn" type="email" name="Email"
