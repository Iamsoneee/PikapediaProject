			...
			<div id="pokedex-blue-shadow">
				<div id="pokedex-blue-frame">
					<div id="pokedex-title-area">
						<span class="pokedex-title-txt">Mypage</span> <img
					...
					<div id="pokedex-white-bg">
						...
						<div class="btn-container">
							...
							<div>
								<img class="user-icon"
									src="img/icon/account-icon/profile-user2.png">
							...
							<div class="confirm-btn-container">
								<div>
									<button class="confirm-btn" type="button"
										onclick="location.href='MyPageEditC'">Edit</button>
								</div>
								<div>
									<button class="confirm-btn" onclick="Signout()">Sign
										Out</button>
								</div>
							</div>
						</div>
