<%@page import="com.pikapedia.detail.DetailPokeBean"%> <%@ page language="java"
...
<html>
  <head>
    ...
    <% DetailPokeBean poketmon = (DetailPokeBean)
    request.getAttribute("poketmon"); %>
    <script>
